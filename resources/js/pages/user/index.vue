				...
				<VRow>
					...
					<VCol cols="12" sm="4">
						<AppAutocomplete v-model="profileFilter" placeholder="Profil" item-title="name"
							item-value="id" :items="[{'name': 'Administrateur', 'id': 'admin'}, {'name': 'Chargé de clientèle', 'id': 'responsible_for_customer'}, {'name': 'Responsable marketing', 'id': 'marketing_manager'}, {'name': 'Chef d\'agence', 'id': 'agency_head'}, {'name': 'Controlleur interne', 'id': 'audit_controller'}]" clearable clear-icon="tabler-x" />
					</VCol>
					<VCol cols="12" sm="4">
						<AppAutocomplete v-model="activatedFilter" placeholder="Activation" item-title="name"
							item-value="id" :items="[{'name': 'Activé', 'id': 'true'}, {'name': 'Désactivé', 'id': 'false'}]" clearable clear-icon="tabler-x" />
					</VCol>
				</VRow>
