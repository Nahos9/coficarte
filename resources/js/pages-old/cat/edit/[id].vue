          ...
          <VCard class="mb-6" title="Information sur CAT">
            <VCardText>
              <VRow>
                ...
                <VCol cols="12" md="6" lg="6">
                  <AppTextField v-model="cat.guarantees_total_amount" :error-messages="catError.guarantees_total_amount" label="Montant total des garanties" placeholder="Ex: 15000600"
